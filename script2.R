...
unique(gdp_europe$country) # 32 countries, 11 aren't members of EU (Albania, Belarus, Latvia, North Macedonia, Moldova, Montenegro, Russia, Switzerland, UK, Ukraine, Norway)
...
gdp_europe_selected <- gdp_europe %>% 
  ...
  filter(!country %in% c("Albania", "Belarus", "Latvia", "North Macedonia", "Moldova", "Montenegro", "Norway", "Russia", "Switzerland", "Ukraine"))
